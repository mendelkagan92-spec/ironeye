...
export default function BottomNav({ active, onChange, hasActiveWorkout }: BottomNavProps) {
  return (
    <nav className="fixed bottom-0 left-0 right-0 safe-bottom z-50"
      style={{ background: '#0f0f0f', borderTop: '1px solid #1a1a1a', height: 64 }}>
      <div className="flex items-stretch max-w-lg mx-auto h-full">
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              <div className="relative">
                <span style={{ color: isActive ? '#fc4c02' : '#4a4a4a' }}>
